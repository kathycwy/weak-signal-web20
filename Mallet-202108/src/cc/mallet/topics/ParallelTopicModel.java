...
public class ParallelTopicModel implements Serializable {
     ...
     *  Files are GZipped.
     *
     * @param interval DataCollection.Save a copy of the state every <code>interval</code> iterations.
     * @param filename DataCollection.Save the state to this file, with the iteration number as a suffix
     */
     ...
     *
     * @param interval DataCollection.Save a serialized model every <code>interval</code> iterations.
     * @param filename DataCollection.Save to this file, with the iteration number as a suffix
     */
